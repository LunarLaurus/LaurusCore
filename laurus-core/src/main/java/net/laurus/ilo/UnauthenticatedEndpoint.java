...
public class UnauthenticatedEndpoint {
	...
	public static UnauthenticatedIloClient getIloClient(IPv4Address ip) throws Exception {
		...
		UnauthenticatedIloClient ilo = new UnauthenticatedIloClient(ip, serialNumber, serverModel, serverId, serverUuid,
				productId, iloText, iloVersion, iloFwBuildDate, iloSerialNumber, iloUuid, healthStatus, nics,
